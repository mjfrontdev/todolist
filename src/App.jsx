...
function AppWithRouter() {
  ...
  const pageTitles = {
    ...
    "/categories": "دسته‌بندی تسک‌ها",
    "/completed": "تسک‌های تکمیل‌شده",
    "/settings": "تنظیمات",
    "/about": "درباره ما",
  };
  const title = pageTitles[location.pathname] || "تسک‌ها";

  // تعریف UI صفحه اصلی تسک‌ها به صورت یک تابع
  const MainTasksUI = () => (
    <>
            ...
            >
              ...
              >
                ...
                <div className="flex justify-end gap-2 mt-4">
                  <PushButton onClick={() => setEditingTask(null)} className="bg-gray-500 !bg-gradient-to-tr from-gray-500 to-gray-700">
                    انصراف
                  </PushButton>
                  <PushButton onClick={() => handleEditTask(editingTask)}>
                    ذخیره
                  </PushButton>
                </div>
              </motion.div>
          ...
          {showForm && (
            ...
            >
              ...
              >
                ...
                <div className="flex justify-end gap-2 mt-4">
                  <PushButton onClick={() => setShowForm(false)} className="bg-gray-500 !bg-gradient-to-tr from-gray-500 to-gray-700">
                    انصراف
                  </PushButton>
                  <PushButton onClick={handleAddTask}>
                    افزودن
                  </PushButton>
                </div>
              </motion.div>
  ...
  return (
    ...
    >
      ...
      {/* حذف کد تکراری motion.div و ul و ... */}
      ...
      >
        <Header
          ...
          title={title}
        />
        {/* اینجا روتینگ را اضافه می‌کنیم */}
        <div className="flex-1 px-2 mt-2 overflow-y-auto pb-24">
          <Routes>
            <Route path="/" element={<MainTasksUI />} />
